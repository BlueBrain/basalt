...
latex_documents = [
    (master_doc, 'Basalt.tex', 'Basalt Documentation',
     'BlueBrain HPC Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'basalt', 'Basalt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Basalt', 'Basalt Documentation',
     author, 'Basalt', 'One line description of project.',
     'Miscellaneous'),
]
