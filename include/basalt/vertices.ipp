...
Status Vertices<Ordered>::insert(const vertex_uid_t& vertex, const Payload& data, bool commit) {
...
template <bool Ordered>
template <typename T>
Status Vertices<Ordered>::get(const vertex_uid_t& vertex, T& payload) const {
    std::string data;
